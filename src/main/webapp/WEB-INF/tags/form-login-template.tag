...
<main class="content" >
    <form action="${formAction}">
        <div class="form-section">
           ...
           <input type="email" class="fontAwesome form-input fa fa-email" id="email"placeholder=" &#xf0e0; ${firstPlaceholder}">
        </div>
        <div class="form-section">
            <label for="pwd">Senha</label>
           <input type="password"  class="fontAwesome form-input fa fa-email" id="pwd" placeholder=" &#xf023; ${secondPlaceholder}">
        </div>
        <button type="submit" class="blue-bg button">Entrar</button>
    </form>
</main>
